        ...
        if(!empty($_POST['pos'])){ 
            ...
            $empQuery = "SELECT			
                        ...
                        WHERE 
                            ...
                            E.GroupNum = G.GroupNum and p.PositionName = '".$posemp."' ";
            ...
            while($row = mysqli_fetch_array($resEmp)){
                ...
                <th>
                    ...
                    href = 'updateemp.php?empUp=<?php echo $posemp; ?>' class='btn-adminAction'>Update</a>
                </th>
                <th>
                    <a style='text-decoration:none;color:red;font-size:15px;margin-right:30px;'
                    href = 'DeleteEmp.php?empUp=<?php echo $posemp; ?>' class='btn-adminAction'>Delete</a>
                </th>
